...
use ShopifyPlugin\Http\Middleware\PreventRequestsDuringMaintenance;
use ShopifyPlugin\Http\Middleware\RedirectIfAuthenticated;
use ShopifyPlugin\Http\Middleware\TrimStrings;
use ShopifyPlugin\Http\Middleware\TrustProxies;
use ShopifyPlugin\Http\Middleware\VerifyCsrfToken;
